...
const TopTierFeature = () => {
  ...
  return (
    <div className=" flex flex-col text-white py-14 items-center w-full">
      <div className="flex gap-36 justify-start mb-10">
        <div className="text-4xl font-bold w-72">OUR TOPTIER FEATURES</div>
        <p className="justify-start mb-8 w-[420px] text-base ">
          Soundbox is a streaming service that allows you to listen to millions
          of songs. Its great features include the ability to download your
          favorite tracks and play them offline, lyrics in real time, listening
          across all your favorite device.
        </p>
      </div>
      ...
      <div className="flex gap-10 justify-center">
        {features.map((feature, index) => (
          <div
            key={index}
            className="w-1/4 bg-[#162A47] shadow-lg text-white rounded-2xl px-6 py-12 "
          >
            <div className="gap-4 mb-10">
              ...
              <div>
                <p className="text-2xl font-bold pt-6">{feature.title}</p>
